...
\begin{enumerate}
	...
	This is a prestigious and more demanding option aimed at nurturing the next generation of researchers.
	\begin{itemize}
		...
		\item \textbf{Benefits:} Successful completion is recorded on your transcript, and strong performance can lead to early admission offers for research postgraduate programmes (MPhil/PhD) at HKU.
	\end{itemize}
	
	\item \textbf{Mitacs Globalink Research Internship (GRI)} \\
	\url{https://intlaffairs.hku.hk/globalink-research-internship} \\
	This is a competitive initiative for research specifically in Canada.
	\begin{itemize}
		\item \textbf{Destination:} Canadian universities.
		\item \textbf{Nature:} A 12-week intensive research internship during the summer (May to September).
		\item \textbf{Funding:} Each intern will be offered stipend and allowance in a total amount of around *CAD9,000 for airfare, transportation, accommodation and living expense in Canada, etc.
		\item \textbf{Application:} The process involves a competitive matching system where you apply to specific projects proposed by Canadian professors.
	\end{itemize}
...
to prepare for the HKU interview:
\url{https://github.com/mathgatito/hku-math-compass/tree/main/HKUInterview%20Prep}.
...
Amidst the solitude of research and the pressure of applications, do not forget the world outside of academia. Remember that you can always return to your family, friends, and mentors. A long-running study at Harvard has pointed out that stable and healthy relationships are the key to sustained happiness---far more so than career achievements. To them, you are not a GPA, a publication count, or a future PhD candidate; you are simply their child, sibling, friend, or student. They will always support you, regardless of whether you solve that open problem or secure that fellowship.\\

When the path becomes too narrow, remember that you can always turn around. There are hundreds of ways to navigate the world, and you can surely be successful regardless of whether you get into a specific graduate program or not.\\
