...
landscape change. For that reason, we are distributing this guide together with its \LaTeX{}
source.

We encourage you to adapt, update, and improve it for the next generation of students. If you
found something outdated, incomplete, or simply wrong, please fix it and pass it on.
...
Regardless of whether you join a formal research program, there is one non-negotiable task you must complete during your Year 1 summer: \textbf{Master \LaTeX}.

\LaTeX\ is the standard typesetting system for mathematics and science. As a math major, Microsoft Word is no longer sufficient. You will need \LaTeX\ to type up your research findings, submit advanced course assignments, and eventually write your thesis.
